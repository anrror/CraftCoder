...
/// 【核心职责】区分用户、Agent、Plan 阶段/节点、工具调用、工具结果、错误和系统八种角色。
...
impl ChatRole {
    ...
    pub fn color(self) -> Color {
        match self {
            ...
            ChatRole::PlanPhase => Color::Blue,
            ChatRole::PlanNode => Color::Cyan,
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            ChatRole::PlanPhase => "Plan Phase",
            ChatRole::PlanNode => "Plan Node",
