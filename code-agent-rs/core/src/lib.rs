...
// ---------------------------------------------------------------------------
// Sealed modules — internal implementation details
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Facade re-exports — flatten deep module paths for callers
// ---------------------------------------------------------------------------

pub use model::TokenUsage;
pub use model::{ModelProvider, ProviderRegistry};
pub use tools::registry::{DefaultToolRegistry, ToolRegistry};

// Sealed-module re-exports — feedback & flywheel internals
pub use feedback::{export_jsonl, export_jsonl_string, FeedbackCollector, FeedbackEvent, FeedbackSink, NoopFeedbackSink, Rating};
pub use flywheel::{ErrorTrace, FailureCluster, FlywheelCollector, Suggestion};
